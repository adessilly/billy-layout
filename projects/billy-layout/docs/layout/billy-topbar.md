...
Consumed tokens: `BILLY_SHELL_CONFIG` (`{ optional: true }`) for `homeLink` and `logout`.
...
- The logo points to `assets/images/icon-384.png`: the asset must exist in the host application.
