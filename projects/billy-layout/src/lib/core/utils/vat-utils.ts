...
//
// Canonical value: "BE0123456749" — country code + body, no separator.
// Display:         "BE 0123.456.749" — prefix and dots greyed out.
//
...
export abstract class VatUtils {
  ...
  /** Canonical form: "BE 0123.456.749" → "BE0123456749". */
