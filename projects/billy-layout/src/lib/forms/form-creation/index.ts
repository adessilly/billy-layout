...
import { InputPrefixeSuffixeComponent } from './input-prefixe-suffixe/input-prefixe-suffixe.component';
...
export { InputPrefixeSuffixeComponent } from './input-prefixe-suffixe/input-prefixe-suffixe.component';
